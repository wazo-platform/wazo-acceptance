...
class Prerequisite(object):
    ...
    def _prepare_trunk(self):
        ...
        trunkcustom_manager_ws.add_or_replace_customtrunk(data1)
        data2 = {'name': 'dahdi-g2',
                 'interface': 'dahdi/g2'
                 }
        trunkcustom_manager_ws.add_or_replace_customtrunk(data2)
    ...
    def _prepare_incall(self):
        ...
        if not incall_exist:
            ...
            incall.destination = UserDestination(line_manager_ws.find_line_id_with_number('101', 'default')[0])
        ...
        if not incall_exist:
            ...
            incall.number = '1002'
            incall.context = 'from-extern'
            incall.destination = UserDestination(line_manager_ws.find_line_id_with_number('102', 'default')[0])
            world.ws.incalls.add(incall)
    ...
    def _prepare_outcall(self):
        ...
        if not outcall_exist:
            ...
            outcall.trunks = trunkcustom_manager_ws.find_customtrunk_id_with_name('dahdi-g2')

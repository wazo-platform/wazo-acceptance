Feature: Queue Member xlet
    ...
    Scenario: Enable and Disable Hide Unlogged Agents
        ...
        Given there is a logged agent "Pascal" "Cadotte Michaud" with number "1003"
	When I start the XiVO Client
	...
	Then the Queue members xlet should display agents:
        | number |
        |   1001 |
	...
	When I add agent "1003" the to "SuperQueue"
	Then the Queue members xlet should display agents:
        | number |
        |   1003 |

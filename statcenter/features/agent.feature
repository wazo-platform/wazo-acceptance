Feature: WEBI Agent Stats
    ...
    Scenario: Scenario de la mort qui tue
        Given there is no entries in queue_log between "2012-01-01 00:00:00" and "2012-01-01 15:00:00"
        Given there is a agent "Agent" "10" with extension "10@statscenter"
        Given there is a queue "q10" with extension "5010@statscenter"
        Given there is a statistic configuration "test_login_time_10" from "7:00" to "15:00" with queue "q10" and agent "10"
        Given I have the following queue_log entries:
          | time                       | callid       | queuename | agent    | event               | data1              |        data2 | data3         | data4 | data5 |
          | 2012-01-01 07:31:00.000000 | NONE         | NONE      | Agent/10 | AGENTCALLBACKLOGIN  | 1003@default       |              |               |       |       |
          | 2012-01-01 08:15:00.000000 | NONE         | NONE      | Agent/10 | AGENTCALLBACKLOGOFF | 1003@default       |         2700 | CommandLogoff |       |       |
          | 2012-01-01 08:16:00.000000 | login_time_1 | NONE      | Agent/10 | AGENTCALLBACKLOGIN  | 1003@default       |              |               |       |       |
          | 2012-01-01 08:20:00.000000 | login_time_2 | NONE      | Agent/10 | AGENTLOGIN          | SIP/aaaaa-00000001 |              |               |       |       |
          | 2012-01-01 08:30:00.000000 | login_time_2 | NONE      | Agent/10 | AGENTLOGOFF         | SIP/aaaaa-00000001 |          840 | CommandLogoff |       |       |
          | 2012-01-01 08:50:00.000000 | login_time_3 | NONE      | Agent/10 | AGENTLOGIN          | SIP/aaaaa-00000002 |              |               |       |       |
          | 2012-01-01 09:10:00.000000 | login_time_3 | NONE      | Agent/10 | AGENTLOGOFF         | SIP/aaaaa-00000002 |         1200 | CommandLogoff |       |       |
          | 2012-01-01 09:30:00.000000 | login_time_4 | NONE      | Agent/10 | AGENTLOGIN          | SIP/aaaaa-00000003 |              |               |       |       |
          | 2012-01-01 09:40:00.000000 | login_time_4 | NONE      | Agent/10 | AGENTLOGOFF         | SIP/aaaaa-00000003 |          600 | CommandLogoff |       |       |
          | 2012-01-01 09:50:00.000000 | login_time_5 | NONE      | Agent/10 | AGENTLOGIN          | SIP/aaaaa-00000004 |              |               |       |       |
          | 2012-01-01 11:10:00.000000 | login_time_5 | NONE      | Agent/10 | AGENTLOGOFF         | SIP/aaaaa-00000004 |         4800 | CommandLogoff |       |       |
          | 2012-01-01 12:29:00.000000 | call_1       | q10       | NONE     | ENTERQUEUE          |                    |       123456 |               |       |       |
          | 2012-01-01 12:30:00.000000 | call_1       | q10       | Agent/10 | CONNECT             | 60                 | 1111111111.1 | 0             |       |       |
          | 2012-01-01 12:31:00.000000 | call_1       | q10       | Agent/10 | COMPLETEAGENT       | 60                 |           60 | 1             |       |       |
#         | 2012-01-01 13:05:00.000000 | login_time_6 | NONE      | Agent/10 | AGENTLOGOFF         | SIP/aaaaa-00000005 |          766 | CommandLogoff |       |       |
          | 2012-01-01 13:29:00.000000 | call_2       | q10       | NONE     | ENTERQUEUE          |                    |       123456 |               |       |       |
          | 2012-01-01 13:30:00.000000 | call_2       | q10       | Agent/10 | CONNECT             | 60                 | 1111111111.1 | 0             |       |       |
          | 2012-01-01 13:31:00.000000 | call_2       | q10       | Agent/10 | COMPLETEAGENT       | 60                 |           60 | 1             |       |       |


        Given I clear and generate the statistics cache
        Then I should have the following statististics on agent "10" on "2012-01-01" on configuration "test_login_time_10":
          |         |    Login |
          | 7h-8h   | 00:29:00 |
          | 8h-9h   | 00:44:00 |
          | 9h-10h  | 00:40:00 |

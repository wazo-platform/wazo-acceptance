Feature: Call Log Generation
    ...
    Scenario: Generation of answered internal call
        ...
        Then I should have the following call logs:
            ...
            | 2015-06-18 14:08:56.910686 | Elès 45     | 1045         | 1001              | 00:00:02.390 |            | True     | sip/as2mkq           | sip/je5qtq                |
    ...
    Scenario: Generation of non-answered internal call
        ...
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_exten | duration | user_field | answered | source_line_identity | destination_line_identity |
            | 2015-06-18 14:10:24.586638 | Elès 45     | 1045         | 1001              |        0 |            | False    | sip/as2mkq           | sip/je5qtq                |
    ...
    Scenario: Generation of answered outgoing call
        ...
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_exten |  duration       | user_field | answered | source_line_identity | destination_line_identity |
            | 2015-06-18 14:12:05.935283 | Elès 01     | 1001         | **9642301         | 00:00:04.338797 |            | True     | sip/je5qtq           | sip/dev_34-1              |
            | 2015-06-18 14:13:18.176182 | Elès 01     | 1001         | **9642301         | 00:00:02.94681  | foo        | True     | sip/je5qtq           | sip/dev_34-1              |
    ...
    Scenario: Generation of originate call
        ...
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_exten |  duration       | user_field | answered | source_line_identity | destination_line_identity |
            | 2015-06-18 14:15:12.978338 | Elès 45     | 1045         | 1001              | 00:00:02.813219 |            | True     | sip/as2mkq           | sip/je5qtq                |
    ...
    Scenario: Generation of unanswered originate call
        ...
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_exten | duration | user_field | answered | source_line_identity | destination_line_identity |
            | 2015-06-18 14:15:48.836632 | Elès 45     | 1045         | 1001              |        0 |            | False    | sip/as2mkq           | sip/je5qtq                |
    ...
    Scenario: Generation of originates hung up by the switchboard
     ...
     Scenario: Generation for a specified latest CEL count with no processed calls
        ...
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_exten | duration        | user_field | answered | source_line_identity | destination_line_identity |
            | 2015-06-18 14:17:32.195429 | Elès 45     | 1045         | 1001              | 00:00:03.460343 |            | True     | sip/as2mkq           | sip/je5qtq                |
        Then I should not have the following call logs:
            | date                       | source_name | source_exten | destination_exten | duration        | user_field | answered | source_line_identity | destination_line_identity |
            | 2015-06-18 14:17:15.314919 | Elès 45     | 1045         | 1001              | 00:00:04.619293 |            | True     | sip/as2mkq           | sip/je5qtq                |
            | 2015-06-18 14:17:24.135378 | Elès 45     | 1045         | 1001              | 00:00:03.410437 |            | True     | sip/as2mkq           | sip/je5qtq                |

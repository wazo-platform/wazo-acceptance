...
LINE_EXTENSIONS_URL = 'lines/%s/extensions'
EXTENSION_LINE_URL = 'extensions/%s/line'
DISSOCIATE_LINE_EXTENSION_URL = 'lines/%s/extensions/%s'


def associate_extension(line_id, extension_id):
    parameters = {

...
def when_i_edit_group_ranges(step):
    group = world.browser.find_element_by_xpath(
        "//li[@id='dwsm-tab-3']//a[@href='#group']")
    group.click()
...
def when_i_add_group_interval(step, start, end):
    ...
    add_button = world.browser.find_element_by_xpath(
        "//div[@id='sb-part-group']//a[@id='add_line_button']")
    add_button.click()
    ...
    start_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-group']//input[@name='contextnumbers[group][numberbeg][]']")[-1]
    start_field.clear()
    start_field.send_keys(start)
    end_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-group']//input[@name='contextnumbers[group][numberend][]']")[-1]
    end_field.clear()
...
def when_i_edit_conference_room_ranges(step):
    group = world.browser.find_element_by_xpath(
        "//li[@id='dwsm-tab-5']//a[@href='#meetme']")
    group.click()
...
def when_i_add_conference_room_interval(step, start, end):
    ...
    add_button = world.browser.find_element_by_xpath(
        "//div[@id='sb-part-meetme']//a[@id='add_line_button']")
    add_button.click()
    world.browser.find_element_by_id('contextnumbers-meetme', 'Meetme line not shown')
    start_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-meetme']//input[@name='contextnumbers[meetme][numberbeg][]']")[-1]
    start_field.clear()
    start_field.send_keys(start)
    end_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-meetme']//input[@name='contextnumbers[meetme][numberend][]']")[-1]
    end_field.clear()
    end_field.send_keys(end)
    submit_form()
...
def when_i_add_incall_interval(step, start, end, did_length):
    ...
    add_button = world.browser.find_element_by_xpath(
        "//div[@id='sb-part-last']//a[@id='add_line_button']")
    add_button.click()
    ...
    start_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-incall']//input[@name='contextnumbers[incall][numberbeg][]']")[-1]
    start_field.clear()
    start_field.send_keys(start)
    end_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-incall']//input[@name='contextnumbers[incall][numberend][]']")[-1]
    end_field.clear()
    end_field.send_keys(end)
    ...
    did_length_select = world.browser.find_elements_by_xpath(
        '//select[@name="contextnumbers[incall][didlength][]"]//option[@value="%s"]' % did_length)[-2]
...
def when_i_add_user_interval(step, start, end):
    add_button = world.browser.find_element_by_xpath(
        "//div[@id='sb-part-user']//a[@id='add_line_button']")
    add_button.click()
    world.browser.find_element_by_id('contextnumbers-user')

    # Do not erase the first line, so select the last one with find_elements...()[-1]
    start_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-user']//input[@name='contextnumbers[user][numberbeg][]']")[-1]
    start_field.clear()
    start_field.send_keys(start)
    end_field = world.browser.find_elements_by_xpath(
        "//tbody[@id='contextnumbers-user']//input[@name='contextnumbers[user][numberend][]']")[-1]
    end_field.clear()
    end_field.send_keys(end)
    submit_form()

...
class RestUsers():
    ...
    def get_all_users(self):
        return self.ws_utils.rest_get("%s/" % URI_PREFIX)
    ...
    def get_user(self, userid):
        return self.ws_utils.rest_get("%s/%s" % (URI_PREFIX, str(userid)))
    ...
    def create_user(self, fullname, description, ctiprofileid=None):
        ...
        return self.ws_utils.rest_post("%s/" % URI_PREFIX, data)
    ...
    def update_user(self, userid, firstname=None, lastname=None):
        ...
        if(firstname is not None):
            data['firstname'] = firstname
        return self.ws_utils.rest_put("%s/%d" % (URI_PREFIX, userid), data)

Feature: Stat
    ...
    Scenario: Generation of event WRAPUPSTART
        ...
        Given there is a agent "Agent" "014" with extension "014@statscenter" with wrapup time "15"
        Given there is a queue "q14" with extension "5014@statscenter" with agent "014"

Feature: Call Log Generation
    ...
    Scenario: Generation of answered internal call
        ...
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_name | destination_exten | duration       | user_field |
            | 2013-01-01 08:46:20.118025 | Bob Marley  | 1002         | Alice Aglisse    | 1001              | 0:00:03.854485 |            |
    ...
    Scenario: Generation of non-answered internal call
        ...
        Then I should have the following call logs:
            | date                    | source_name | source_exten | destination_name | destination_exten | duration | user_field |
            | 2013-01-01 08:46:31.981 | Bob Marley  | 1002         | Alice Aglisse    | 1001              | 0        |            |

    Scenario: Generation of answered incoming call
        Given there are no calls
        Given I have the following CEL entries:
            | eventtype    | eventtime                  | cid_name   | cid_num    | exten | context     | uniqueid      | linkedid      | userfield |
            | CHAN_START   | 2013-01-01 11:02:38.435558 | 612345678  | 612345678  | 1002  | from-extern | 1376060558.17 | 1376060558.17 |           |
            | APP_START    | 2013-01-01 11:02:38.854908 |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
            | CHAN_START   | 2013-01-01 11:02:38.855169 | Bob Marley | 1002       | s     | default     | 1376060558.18 | 1376060558.17 |           |
            | ANSWER       | 2013-01-01 11:02:42.30618  | Bob Marley | 1002       | s     | default     | 1376060558.18 | 1376060558.17 |           |
            | ANSWER       | 2013-01-01 11:02:42.306333 |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
            | BRIDGE_START | 2013-01-01 11:02:42.30635  |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
            | BRIDGE_END   | 2013-01-01 11:02:45.813774 |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
            | HANGUP       | 2013-01-01 11:02:45.824011 | Bob Marley | 1002       |       | user        | 1376060558.18 | 1376060558.17 |           |
            | CHAN_END     | 2013-01-01 11:02:45.824039 | Bob Marley | 1002       |       | user        | 1376060558.18 | 1376060558.17 |           |
            | HANGUP       | 2013-01-01 11:02:45.834265 |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
            | CHAN_END     | 2013-01-01 11:02:45.834401 |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
            | LINKEDID_END | 2013-01-01 11:02:45.834408 |            | 0612345678 | s     | user        | 1376060558.17 | 1376060558.17 |           |
        When I generate call logs
        Then I should have the following call logs:
            | date                       | source_name | source_exten | destination_name | destination_exten | duration       | user_field |
            | 2013-01-01 11:02:38.855169 | 612345678   | 612345678    |                  | 1002              | 0:00:03.527932 |            |
    ...
    Scenario: Generation of answered outgoing call
        ...
        Then I should have the following call logs:
            | date                  | source_name | source_exten | destination_name | destination_exten | duration  | user_field |
            | 2013-01-01 11:03:47.0 | Bob Marley  | 1002         |     NULL         | 4185550155        | 0:00:03.0 |            |
            | 2013-01-01 11:20:08.0 | Bob Marley  | 1002         |     NULL         | 4185550155        | 0:00:05.0 | 00548AB33  |

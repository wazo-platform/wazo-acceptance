Feature: Switchboard
    ...
    Scenario: Blind transfer
        ...
        When I start the XiVO Client
        When I log in the XiVO Client as "switch", pass "board"
        # When the user "Transfer" "Destination" calls "3009"
        # When the switchboard operator answers
        # When the switchboard operator makes a blind transfer to "Transfer" "Destination"
        # Then "User" "Caller" rings at "Transfer" "Destination"
        # When "Transfer" "Destination" answers
        # Then "User" "Caller" can talk to "Transfer" "Destination"
